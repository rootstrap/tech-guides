...
prescriptions for Ruby on Rails 4/5 development.
...
* <a name="model-business-logic"></a>
  ...
  place is in decorators. Keep your models for business logic and data-persistence
  only.
...
* <a name="local-smtp"></a>
  ...
  environment. Or [Letter Opener](https://github.com/ryanb/letter_opener) that previews the email in the browser.
...
[Original Ruby style guide](https://github.com/bbatsov/rails-style-guide)
