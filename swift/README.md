# The Swift 3 Style Guide

This Swift style guide recommends best practices so that real-world Swift
programmers can write code that can be maintained by other real-world Swift
...
Where an Xcode project is involved, the organization should be set to `Rootstrap` and the Bundle Identifier set to `com.rootstrap.ProjectName` where `ProjectName` is the name of the project.
